...
leaflet() %>%
  ...
  # Mentions as heatmap (optional alternative or extra layer)
  # Uncomment this section if you want a density heatmap instead
   leaflet.extras::addHeatmap(data = newspapers_4326, 
                              intensity = 1, blur = 20, max = 0.05,
                               radius = 15, group = "Mention Density") %>%
  ...
  # Layer controls
  addLayersControl(
    overlayGroups = c("Mentions", "Schools"),
